modelInfo <- list(label = "Nu-Support Vector Regression with Polynomial Kernel",
                  library = "kernlab",
                  type = c("Regression", "Classification"),
                  parameters = data.frame(parameter = c('degree', 'scale', 'C', "epsilon", "nu"),
                                          class = c("numeric", "numeric", "numeric","numeric","numeric"),
                                          label = c('Polynomial Degree','Scale', 'Cost',"Epsilon", "Nu")),
                  ...
                  sort = function(x) x[order(x$degree, x$C,x$nu,x$epsilon, x$scale),])
